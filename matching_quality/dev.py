...
# 输入两篇文档计算相似度
data1 = pd.read_csv(r'./data/2020_patient_physician.csv', encoding='utf-8')  ## 多个问题作为第一篇文档的输入
data2 = pd.read_csv(r'./data/2020_patient_physician.csv', encoding='utf-8')  ## 多个候选医生的dialogues作为第二篇文档的输入
...
result3.to_csv('./output/validation_5000_MPNet.csv')
